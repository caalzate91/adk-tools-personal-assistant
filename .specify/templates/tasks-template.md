...
Unit, integration, and e2e tests MUST be created and committed before the implementation they cover (TDD).
...
> **NON-NEGOTIABLE: Write these tests FIRST, commit them, confirm they FAIL, then implement**
